...
const reviewsFeatures = [
  ...
  "A steady stream of fresh reviews that builds trust and wins you the click",
];
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
        {/* WEBSITE PLAN */}
        <BlurIn delay={0.1}>
          <div className="relative h-full flex flex-col rounded-2xl p-7 lg:p-8 bg-card border border-card-border">
            <div>
            ...
            <div className="mt-8">
              <div className="flex items-baseline gap-1">
                <span className="text-5xl font-medium text-white">$97</span>
        ...
        {/* WEBSITE + REVIEWS — recommended */}
        <BlurIn delay={0.2}>
          <div className="relative h-full flex flex-col rounded-2xl p-7 lg:p-8 bg-gradient-to-b from-accent/10 to-card border border-accent/40 lg:scale-[1.03] shadow-2xl shadow-accent/10">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm mt-2 leading-relaxed">
                Your website plus a review engine that fills your Google profile
                with 5-star reviews. The fastest way to look great online and
                earn the trust that wins the call.
              </p>
            </div>

            <div className="mt-8">
              <div className="flex items-baseline gap-1">
                <span className="text-5xl font-medium text-white">$147</span>
                <span className="text-white/50 text-base">/month</span>
              </div>
        ...
        <BlurIn delay={0.3}>
          <div className="relative h-full flex flex-col rounded-2xl p-7 lg:p-8 bg-card border border-card-border">
            ...
            <div className="mt-8">
              <div className="flex items-baseline gap-1">
                <span className="text-5xl font-medium text-white">$297</span>
                <span className="text-white/50 text-base">/month</span>
              </div>
              <div className="text-white/50 text-xs mt-2 font-medium">
                No setup fee · Month-to-month · Cancel anytime
      ...
      <BlurIn delay={0.4}>
        <div className="mt-8 rounded-xl bg-accent/10 border border-accent/20 p-4 max-w-3xl mx-auto">
          <p className="text-white/80 text-sm leading-relaxed text-center">
            ...
            No big setup fee on any plan. Your first month gets your site built
            and live. If I don&apos;t have you live within 10 business days, your
            next month is on me.
          </p>
        </div>
      </BlurIn>
