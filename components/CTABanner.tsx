    ...
    <section className="relative overflow-hidden grain-overlay py-24 lg:py-32 border-t border-black/10">
      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          Reviews with a 5-star review engine at $147/month, or the full Growth
          System — Google presence and SEO too — at $297/month. Built and
          managed for you. No setup fee, cancel anytime.
        </Reveal>
