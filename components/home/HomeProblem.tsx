...
// Homepage problem section (condensed): the search-results comparison and the
// two-failure-points framing (reviews win the click, the website wins the call).
// The old four story-cards were dropped — the flywheel + review engine that
// follow already make those points.
  ...
  return (
    <section className="relative">
      <div className="relative grain-overlay py-14 lg:py-32">
        ...
        <div className="relative w-full max-w-2xl mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="mt-4 lg:mt-6 text-[#0c0b1e]/60 text-base sm:text-lg leading-relaxed max-w-xl mx-auto">
            Two things decide whether that search becomes your phone call: the
            reviews that win the click, and the website that wins the call once
            they land. Lose either one and Google hands the customer to a
            competitor with a head start.
          </p>

          {/* Search → map → ranking card */}
          <div className="relative mt-8 lg:mt-10 text-left rounded-[28px] border border-black/[0.07] bg-white shadow-2xl shadow-[#0c0b1e]/10 p-5 sm:p-6 max-w-lg mx-auto">
            <div
              aria-hidden
