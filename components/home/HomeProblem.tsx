...
// Homepage problem section — the /grow "already searching" problem, widened
// one notch: reviews decide whether they click you, and the website decides
// whether they call once they land. Two failure points, one loop.
const stories = [
  {
    n: "01",
    tag: "Trust",
    ...
    body: "Before anyone visits your site, they scan your star rating, your most recent reviews, and how you reply. That quick read decides whether you get the click or the next business does.",
  },
  {
    n: "02",
    tag: "The click",
    ...
    dot: "bg-cyan",
    glow: "shadow-cyan/15",
    title: "A dated site sends the click right back.",
    body: "Winning the click is only half the job. If they land on a slow, outdated website, they hit the back button and pick the competitor whose site looked the part.",
  },
  {
    n: "03",
    tag: "Speed",
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            <div>
              ...
              <p className="mt-4 lg:mt-6 text-[#0c0b1e]/60 text-base sm:text-lg leading-relaxed max-w-md">
                Two things decide whether that search becomes your phone call: the
                reviews that win the click, and the website that wins the call
                once they land. Lose either one and Google hands the customer to
                the competitor with a head start.
              </p>
