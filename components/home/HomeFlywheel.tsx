...
// The homepage flywheel — the /grow wheel with the website folded into the
// loop, so both halves of the product (reviews + website) appear in the cycle.
const steps = [
  { icon: Search, label: "Someone searches", sub: "Ready to hire", color: "from-cyan to-accent", text: "text-[#0e8090]" },
  { icon: Star, label: "Reviews win the click", sub: "You look safe to call", color: "from-accent to-violet", text: "text-accent" },
  { icon: MousePointerClick, label: "Website wins the call", sub: "Fast, built to convert", color: "from-violet to-cyan", text: "text-[#8b3fd6]" },
  { icon: Inbox, label: "Lead lands in one inbox", sub: "Nothing slips through", color: "from-cyan to-amber", text: "text-[#0e8090]" },
  { icon: MessageSquare, label: "Smart review ask", sub: "A job well done", color: "from-amber to-violet", text: "text-[#b45309]" },
  { icon: ShieldCheck, label: "Stronger profile", sub: "Back to the top", color: "from-violet to-accent", text: "text-[#8b3fd6]" },
];
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 xl:gap-16 lg:items-center">
          ...
          <div className="text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            ...
            <p className="mt-4 lg:mt-5 text-[#0c0b1e]/60 text-base sm:text-lg leading-relaxed">
              Reviews win the click, the website wins the call, and every happy
              customer feeds the next review. Each piece makes the next one work
              harder — and the wheel keeps turning.
            </p>
